(function () {
    ...
    // ===============================================
    const apiKey = "pl_live_f22a168c4459bd3489ad0a4677fbf86e8e1b280aa8ee8320bfc8398d8c8b54dd";
    window.PROVOU_LEVOU_API_KEY = apiKey;

    const WEBHOOK_PROVA = 'https://n8n.segredosdodrop.com/webhook/gerador-oculos';
    const WEBHOOK_PIX = 'https://n8n.segredosdodrop.com/webhook/fortuna-pix';
    const WEBHOOK_PIX_STATUS = 'https://n8n.segredosdodrop.com/webhook/fortuna-pix-status';
    const WEBHOOK_CHECK_LIMIT = 'https://n8n.segredosdodrop.com/webhook/fortuna-check-limit';
...
const fd = new FormData();
                    ...
                    console.log('[PL Fortuna] Enviando', allProdImgs.length, 'fotos do produto');
